...
var config_fields = [ 'testAuthenticator', 'productionAuthenticator', 'testAuthenticatorChina', 'productionAuthenticatorChina', 'contentModel', 'rentalPeriod' ];
...
exports.load = function (callback) {
  ...
  //Fluff.app.post ('/LicensingService.ashx', tokens.licenseRequest);
