...
exports.Info = {
  ...
  db_uri      : 'mongodb://localhost:27017/fluff' // Used when app_service is 'Custom'. Fluff will fall back to this uri if the Heroku or AppFog environment variable is missing.
}